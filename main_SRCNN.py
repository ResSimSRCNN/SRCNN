...
training, testing = cf.matrix_org_with_timesteps_without_timesteps(
    "./data_extraction_with_timesteps.mat", train_set=450, step_num=3)
...
path = "./data/good_model/" + str(ite_num)
os.mkdir(path)
path = path + "/"
...
cf.plotting(pics=plot_maps, names=plot_labels, color_map=cf.color_map())
