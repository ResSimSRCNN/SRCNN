...
def Create_Model(filters=None, kernel_size=None, activations=None, num_of_steps=None):
    ...
    output_layer = ConvLSTM2D(filters=2, kernel_size=1,
                              padding='same', return_sequences=True, activation='relu')(merged)
